!function (e) {
    e.fn.weekly_schedule = function (t) {
        ...
        function r(e) {
            var t = [], o = e.toUpperCase().split("-"), r = parseInt(o[0].split(":")[0]),
                n = parseInt(o[1].split(":")[0]), a = o[0].includes("PM") ? r + 12 : r,
                i = o[1].includes("PM") ? n + 12 : n, s = a;
            for (s; i >= s; s++) {
                var d = "";
                d += s > 12 ? "" + (s - 12) + ":00PM" : 12 == s ? "" + s + ":00PM" : "" + s + ":00AM", t.push(d)
            }
            return t
        }
        ...
        function a(t) {
            for (var o = e(t).attr("class").split(" ")[1], r = e(".day"), n = 0; n < r.length; n++) if (!e(r[n]).hasClass(o)) for (var a = e(r[n]).children(), s = 0; s < a.length; s++) e(a[s]).addClass("disabled");
        ...
        function i() {
            for (var t = e(".day"), o = 0; o < t.length; o++) for (var r = e(t[o]).children(), n = 0; n < r.length; n++) e(r[n]).removeClass("disabled")
        }
        ...
        if ("string" == typeof t) switch (t) {
            ...
            var c = s.days, u = s.hoursParsed;
            e(h).addClass("schedule");
            var p = e("<div></div>", {"class": "header"}), f = e("<div></div>", {"class": "align-block"});
            p.append(f);
            for (var g = 0; g < c.length; ++g) {
                var v = e("<div></div>", {"class": "header-item " + c[g] + "-header"}),
                    m = e("<h3>" + n(c[g]) + "</h3>");
                v.append(m), p.append(v)
            }
            var y = e("<div></div>", {"class": "days-wrapper"}), C = e("<div></div>", {"class": "hour-header"});
            y.append(C);
            for (var g = 0; g < u.length; g++) {
                var x = e("<div></div>", {"class": "hour-header-item " + u[g]}), m = e("<h5>" + u[g] + "</h5>");
                x.append(m), C.append(x)
            }
            for (var g = 0; g < c.length; g++) {
                for (var b = e("<div></div>", {"class": "day " + c[g]}), w = 0; w < u.length; w++) {
                    var k = e("<div></div>", {"class": "hour " + u[w]});
                    b.append(k)
                }
                y.append(b)
            }
